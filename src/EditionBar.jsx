 ...
 render(){
     return (
            <nav className="editionBar__nav">
                    ...
                    <button className="editionBar__button buttons"><img src={require('./images/information.-button.svg')}  className="navBar__images openMenu"/><span className="editionBar__span buttonFont hiddenControl">Note info</span></button>

                    <button className="editionBar__button buttons"><img src={require('./images/trash-button.svg')}  className="navBar__images openMenu"/><span className="editionBar__span buttonFont hiddenControl">Delete Note</span></button>

                    <button className="editionBar__button buttons"><img src={require('./images/share-links.svg')}  className="navBar__images openMenu"/><span className="editionBar__span buttonFont hiddenControl">Copy Notelink</span></button>
            </nav>
    );
  },
});
